...
$.fn.jqmShow = function(t) {
        return this.each(function() {
            ...
            var _top = $(document).scrollTop() + 10 + "px";
            if(typeof _HRTECHUI_ENABLED != "undefined" && _HRTECHUI_ENABLED == true){
	            $(".jqmWindow").css("top", "-800px" );
	            $(".jqmWindow").removeClass("jqmWindowAnimateClass");
	            $(".jqmWindow").animate({"top": _top}, 300 );
            }else{
            	$(".jqmWindow").css("top", _top );
            }
        });
    };
...
hash:{},
open:function(s,t){
	// 100% width is only taking the visible portion of the window. But we want to cover all the portion.
	...
	h.w.css('z-index',z);
	if( typeof _HRTECHUI_ENABLED != "undefined" && _HRTECHUI_ENABLED == true ){
		h.w.addClass("jqmWindowAnimateClass");
	}
